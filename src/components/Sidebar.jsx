...
const Sidebar = () => {
  ...
  const organizationItems = isAdmin
    ...
    : organizationItem;
  return (
    <div className="h-[calc(100vh-60px)] bg-gradient-to-r from-indigo-600 to-blue-500 border-gray-200 border-r w-[75vw]  md:w-72 lg:w-72 xl:w-72 2xl:w-96 fixed left-0 rounded-r-xl flex flex-col justify-between">
      ...
      <div className="p-4">
        <button
          onClick={logout}
          className="bg-white text-blue-500 w-full p-2 rounded-3xl text-lg font-semibold hover:bg-gray-100 hover:text-black flex justify-center gap-2 items-center transition-all ease-in-out duration-200"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div className="mt-3 text-center text-white font-semibold text-sm">
