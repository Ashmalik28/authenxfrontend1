...
const Admin = () => {
  ...
  const { currentAccount, approveOrg, getAllDocuments } =
            ...
            {requests.map((req, index) => (
              ...
              >
                <div className="text-lg font-semibold">
                  {req.kycDetails.orgName}
                </div>
                <div>{req.kycDetails.orgType}</div>
                <div>
                  <p className="text-sm font-semibold">
                    {req.kycDetails.officialEmail}
                  </p>
                  <p className="text-xs text-blue-600">
                    {req.kycDetails.website}
                  </p>
                </div>
                <div>{req.kycDetails.country}</div>
                <div>
                  <p className="text-sm font-semibold">
                    {req.kycDetails.contactPerson.fullName}
                  </p>
                  <p className="text-xs text-blue-600">
                    {req.kycDetails.contactPerson.personalEmail}
                  </p>
                </div>
                <div>
                  <a
                ...
                <div className="flex gap-2 justify-start">
                  <button
                    onClick={() =>
                      handleApprove(req.walletAddress, req.kycDetails.orgName)
                    }
                  ...
                  <button
                    onClick={() =>
                      handleStatusUpdate(req.walletAddress, "Rejected")
                    }
          ...
          <div className="flex justify-center bg-blue-700 rounded-b-2xl items-center p-4 gap-3">
            <div className="flex p-1 rounded-xl bg-white">
              ...
              <div
                ...
                className={`px-2 my-1 flex text-sm ${currentPage == 1 ? "bg-blue-700 text-white" : "bg-gray-200"} justify-center items-center rounded-lg mr-2`}
              >
                1
              </div>
              {totalKycDocs > 1 && (
                <div
                  ...
                  className={`px-2 my-1 ${currentPage == 2 ? "bg-blue-700 text-white" : "bg-gray-200"} flex text-sm justify-center items-center rounded-lg mr-2`}
                >
                  2
                </div>
              )}
              {totalKycDocs > 2 && (
                <div
                  ...
                  className={`px-2 my-1 ${currentPage == 3 ? "bg-blue-700 text-white" : "bg-gray-200"} flex text-sm justify-center items-center rounded-lg mr-2`}
                >
                  3
                </div>
              )}
              <div className="px-2 my-1 flex text-sm justify-center items-center rounded-lg bg-gray-200 mr-2">
                ...
              </div>
              <div
                onClick={() => handlePageChange(totalKycDocs)}
                className="px-2 my-1 flex text-sm justify-center items-center rounded-lg bg-gray-200 mr-2"
              >
                {totalKycDocs}
              </div>
        ...
        <div className="flex flex-col flex-1 h-fit m-5 bg-white rounded-2xl">
            ...
            {currentDocs.map((doc, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600">
                    {shortenAddress(doc.orgWallet)}
                  </p>
                </div>
                <div>{doc.issuedAt}</div>
                <div className="truncate text-sm">
                  {shortenAddress(doc.hash)}
                </div>
                <div>
                  <span
                ...
                <div>
                  {loadingIndex === index ? (
                    ...
                    <div className="w-full flex justify-center items-center">
                      <button
                        onClick={() => handleViewDocument(doc.hash, index)}
                        className="bg-blue-700 text-white px-3 py-1 rounded-xl hover:bg-black transition-all duration-300 ease-in-out"
                      >
                        View Doc
                      </button>
                    </div>
          ...
          <div className="flex justify-center bg-blue-700 rounded-b-2xl items-center p-4 gap-3">
            <div className="flex p-1 rounded-xl bg-white">
              ...
              <div
                onClick={() => handlePageChange(totalIssuedPages)}
                className="px-2 my-1 flex text-sm justify-center items-center rounded-lg bg-gray-200 mr-2"
              >
                {totalIssuedPages}
              </div>
          ...
          <div className="p-5 rounded-2xl bg-white outline-2 shadow-md outline-gray-300">
            <div className="w-full flex gap-3 rounded-t-2xl items-center">
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-black text-base">
                  Grant administrative access to new users
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-2 mt-5 w-full">
              ...
              <div className="flex gap-0 w-full outline-1 outline-gray-400 rounded-xl p-3 focus-within:outline-blue-500">
                <input
                  className="w-full outline-none mt-0 text-black "
                  type="text"
                  placeholder="Enter Admins Wallet address (0x....)"
                  id="name"
                />
              </div>
            </div>
            <div className="flex gap-6 justify-center">
              <div className="flex flex-col gap-2 mt-5">
                <label htmlFor="doctype" className="text-black font-semibold">
                  Admin Level *
                </label>
                <div
                  id="doctype"
                  className="flex gap-0 outline-1 w-80 outline-gray-400 rounded-xl relative"
                >
                  <div
              ...
              <div className="flex flex-col gap-2 mt-5 w-full">
                ...
                <div className="flex gap-0 w-full outline-1 outline-gray-400 rounded-xl p-3 focus-within:outline-blue-500">
                  <input
                    className="w-full outline-none mt-0 text-black "
                    type="text"
                    placeholder="Enter Admins email address if available"
                    id="name"
                  />
                </div>
              </div>
            ...
            <div className="flex justify-center">
              <Button
                variant="primary"
                size="md"
                className="before:bg-white rounded-lg w-full hover:scale-0 bg-blue-700 justify-center text-lg outline-blue-400 mt-6 flex gap-2 items-center"
              >
          ...
          <div className="p-5 rounded-2xl bg-white outline-2 shadow-md outline-gray-300">
            <div className="w-full flex gap-3 rounded-t-2xl items-center">
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="text-black text-base">
                  Invalidate issued documents by hash
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-2 mt-5 w-full">
              ...
              <div className="flex gap-0 w-full outline-1 outline-gray-400 rounded-xl p-3 focus-within:outline-blue-500">
                <input
                  className="w-full outline-none mt-0 text-black "
                  type="text"
                  placeholder="Enter Document's hash which you want to invalidate (0x....)"
                  id="name"
                />
              </div>
            </div>
            <div className="flex gap-6 justify-center">
              ...
              <div className="flex flex-col gap-2 mt-5 w-full">
                ...
                <div className="flex gap-0 w-full outline-1 outline-gray-400 rounded-xl p-3 focus-within:outline-blue-500">
                  <textarea
                    className="w-full outline-none mt-0 h-[24px] text-black "
                    type="text"
                    placeholder="Enter Admins email address if available"
                    id="name"
                  />
            ...
            <div className="flex justify-center">
              <Button
                variant="primary"
                size="md"
                className="before:bg-white rounded-lg w-full hover:scale-0 bg-red-700 justify-center hover:text-red-500text-lg outline-red-400 mt-6 flex gap-2 items-center"
              >
                Revoke Document
              </Button>
            </div>
