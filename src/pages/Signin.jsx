  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 flex flex-col items-center">
      ...
      <div className="lg:hidden flex flex-col pb-3 items-center bg-gradient-to-br from-[#0b0f2e] via-[#151a45] to-[#0d1b3f] w-full">
        ...
        <p className="text-white font-bold mt-2 text-xl">Sign in to AuthenX</p>
          ...
          <div className="lg:w-[50%] w-full hidden lg:flex lg:flex-col relative overflow-hidden bg-gradient-to-br from-[#0b0f2e] via-[#151a45] to-[#0d1b3f] p-10">
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex items-center gap-2 mb-6">
                <div className="bg-white/10 rounded-lg px-2 py-1.5 backdrop-blur-sm">
                  <img
                    src={logo}
                    alt="AuthenX"
              ...
              <h2 className="text-3xl xl:text-4xl font-bold text-white leading-tight mb-5">
                Welcome Back to <br /> AuthenX
              </h2>
              <p className="text-gray-400 text-sm leading-relaxed mb-5 max-w-xs">
                Securely access your document verification portal or issuer
                dashboard.
              </p>
              ...
              <div className="flex flex-col gap-5">
                <div
                  ...
                  className={`relative cursor-pointer h-[100px] rounded-2xl p-5 border transition-all duration-300 ${
                    active === "verifier"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Login to verify document authentically.
                      </p>
                    </div>
                    <span
                ...
                <div
                  ...
                  className={`relative cursor-pointer rounded-2xl h-[100px] p-5 border transition-all duration-300 ${
                    active === "organization"
                      ? "bg-gradient-to-br from-indigo-600/40 to-blue-600/30 border-indigo-400/60"
                      : "bg-white/5 border-white/10 hover:bg-white/[0.07]"
                  }`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Access your issuer dashboard via an ethereum wallet.
                      </p>
                    </div>
                    <span
            ...
            {active === "verifier" && (
              <div>
                <div className="lg:mt-4 mt-2">
                  ...
                  <div className="flex items-center gap-2 w-full border border-gray-200 rounded-xl lg:p-3 p-2 bg-[#fafbff] transition-all duration-200 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-100">
              ...
              <div>
                ...
                <div className="w-full bg-gray-50 border border-gray-100 rounded-2xl mt-5 p-6">
                  ...
                  <span
                    ...
                    className="w-full font-bold text-white flex justify-between items-center bg-black hover:bg-neutral-800 py-5 px-5 rounded-xl cursor-pointer transition-colors"
                  >
                    MetaMask
                    <svg
                  ...
                  <div className="flex flex-col gap-3">
                    <span
                      ...
                      className="w-full font-bold text-gray-700 flex justify-between items-center bg-white border border-gray-200 hover:bg-gray-100 py-3.5 px-5 rounded-xl cursor-pointer transition-colors"
                    >
                      Trust Wallet
                      <img
