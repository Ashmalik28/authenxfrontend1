        ...
        <div className="flex flex-1 justify-center xl:ml-96 2xl:ml-130 2xl:mr-0 xl:mr-9 lg:mb-6">
          <div className="ml-3 xs:ml-4 md:ml-10 md:mr-10 lg:ml-23 xl:ml-15 mt-4 lg:mt-6 2xl:m-10 w-full flex bg-[#f8fafc] flex-col gap-6 lg:gap-8 mr-3 xs:mr-4 lg:mr-10">
            ...
            <div className="w-full flex md:items-start items-center flex-col">
              ...
              <p className="text-gray-500 text-sm md:text-start text-center lg:text-base mt-1">
            ...
            <div className="flex w-full flex-col md:flex-row gap-4 lg:gap-6 2xl:gap-8 md:items-start items-center">
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M12 9a3.75 3.75 0 1 0 0 7.5A3.75 3.75 0 0 0 12 9ZM9.53 4.72a2.25 2.25 0 0 1 1.591-.659l1.758 0a2.25 2.25 0 0 1 1.591.659l.879.879c.148.148.34.243.548.27l1.68.223a2.25 2.25 0 0 1 1.949 1.949l.223 1.68c.027.208.122.4.27.548l.879.879a2.25 2.25 0 0 1 0 3.182l-.879.879a.913.913 0 0 0-.27.548l-.223 1.68a2.25 2.25 0 0 1-1.949 1.949l-1.68.223a.913.913 0 0 0-.548.27l-.879.879a2.25 2.25 0 0 1-3.182 0l-.879-.879a.913.913 0 0 0-.548-.27l-1.68-.223a.913.913 0 0 1-.548-.27l-.879-.879a2.25 2.25 0 0 1 0-3.182l.879-.879a.913.913 0 0 0 .27-.548l.223-1.68a2.25 2.25 0 0 1 1.949-1.949l1.68-.223a.913.913 0 0 0 .548-.27l.879-.879Z"
                        clipRule="evenodd"
                      />
                    </svg>
                ...
                <p className="text-black font-bold md:text-base lg:text-lg mt-4 2xl:mt-6">
                  {profile.fullName}
                </p>

                <p className="text-indigo-600 text-[11px] lg:text-xs font-bold uppercase tracking-wide mt-0.5">
                  {profile.roleLabel}
                </p>
                ...
                <p className="text-gray-400 text-[11px] lg:text-xs mt-2 lg:mt-4">
              ...
              <div className="flex flex-col gap-4 mb-6 lg:gap-6 2xl:gap-8">
                ...
                >
                  <p className="text-black font-bold text-sm xs:text-base md:text-lg pb-2 xs:pb-4 mb-3 xs:mb-5 border-b border-gray-100">
                    Personal Information
                  </p>

                  <div className="grid grid-cols-2 md:gap-x-20 lg:gap-x-30 gap-y-6 md:gap-y-8 2xl:mt-6 lg:mr-20 md:mr-10">
                    <div>
                      <p className="text-gray-400 text-[10px] md:text-xs font-bold uppercase tracking-wide">
                        Full Name
                      </p>

                      <p className="text-black font-semibold text-[11px] xs:text-sm mt-1 xs:mt-2">
                        {profile.fullName}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-black font-semibold text-[11px] xs:text-sm mt-1">
                        {profile.createdAt
                ...
                {userType === "organization" && org && (
                  ...
                  >
                    <div className="flex items-center justify-between pb-3 xs:pb-4 mb-3 xs:mb-5 border-b border-gray-100">
                      <p className="text-black font-bold text-sm xs:text-base md:text-lg">
                        Organization Profile
                      </p>
                    ...
                    <p className="text-gray-400 text-[10px] xs:text-[11px] font-bold uppercase 2xl:mt-6 tracking-wide mb-2">
                      Wallet Address
                    </p>
                    ...
                    <div className="flex items-center justify-between bg-gray-50 border border-gray-100 rounded-lg px-2 xs:px-4 py-2 xs:py-4 mb-4 xs:mb-8">
                      <span className="font-mono text-[8px] xs:text-[9px] sm:text-[11px] md:text-xs text-gray-700 truncate font-semibold">
                        {org.walletAddress}
                      </span>
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-5 2xl:gap-y-8">
                      <div>
                        <p className="text-gray-400 text-[10px] xs:text-xs font-bold uppercase tracking-wide">
                          KYC Status
                        </p>

                        <p
                          className={`font-bold text-[11px] xs:text-sm mt-1 xs:mt-2 ${
                            org.verified ? "text-green-600" : "text-red-500"
                          }`}
                        >
                          {org.kycStatus}
                        </p>
                      ...
                      <div>
                        ...
                        <p className="text-black font-bold text-[11px] xs:text-sm mt-1 xs:mt-2">
                          {Number(org.documentsIssued || 0).toLocaleString()}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-black font-bold text-[11px] xs:text-sm mt-1 xs:mt-2">
                          {Number(org.documentsVerified || 0).toLocaleString()}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-black font-bold text-[11px] xs:text-sm mt-2">
                          {Number(org.activeCredentials || 0).toLocaleString()}
                        </p>
                      </div>
                    </div>
                  </motion.div>
